...
class Textractor:
    ...
    def processDocument(self, ips, i, document, res_dir):
    ...
    def run(self):
        ...
        res_dir = os.path.join("./", time.strftime("%Y_%m_%d_%Hh_%Mmin_%Ss"))
        try:
           os.mkdir(res_dir)
        except OSError as e:
        ...
        for document in ips["documents"]:
            ...
            self.processDocument(ips, i, document, file_dir)
